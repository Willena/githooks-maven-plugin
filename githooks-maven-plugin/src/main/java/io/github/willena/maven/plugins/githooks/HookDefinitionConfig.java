...
public class HookDefinitionConfig {
    @Parameter(name = "enabled") private boolean enabled = true;

    @Parameter(name = "name") private String name;

    @Parameter(name = "description") private String description;

    @Parameter(name = "runConfig") private RunConfig runConfig;

    @Parameter(name = "skipIf") private ConditionalRunConfig skipIf;
    @Parameter(name = "onlyIf") private ConditionalRunConfig onlyIf;
    ...
    public boolean equals(Object o) {
        ...
        return enabled == that.enabled && Objects.equals(name, that.name) && Objects.equals(description, that.description) && Objects.equals(runConfig, that.runConfig) && Objects.equals(skipIf, that.skipIf) && Objects.equals(onlyIf, that.onlyIf);
    }
